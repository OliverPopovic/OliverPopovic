...
- ⚙️ [python-repo-template](https://github.com/OliverPopovic/python-repo-template): simple template for starting ML projects with uv
- 📚 [litbot](https://github.com/OliverPopovic/litbot): RAG-based literature chatbot
